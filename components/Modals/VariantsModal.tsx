...
const VariantsModal: React.FC<VarinatModalProps> = ({ skus }) => {
  return (
    <Dialog>
      ...
      <DialogContent className=" overflow-auto sm:rounded-2xl h-fit p-5">
        <DialogHeader>
          <DialogTitle className="text-center text-fontPrimary font-bold">
