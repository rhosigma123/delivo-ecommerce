...
const PrivacyPolicyRoute = () => {
  return (
    <div className="delivo__container mx-auto px-4 py-8">
      ...
      <p className="mb-4">
        We collect various types of information from you when you access or use
        the Platform, register an account, or interact with our services. This
        includes:
      </p>
      <ul className="list-disc list-inside mb-4">
        ...
        <li>
          <strong>Sensitive Personal Information:</strong> Passwords, financial
          information, health data, and biometric information.
        </li>
        <li>
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-4">4. Security Measures</h2>
      <p className="mb-4">
      ...
      <p className="mb-4">
        ...
        purposes outlined in this Privacy Notice or as required by law.
      </p>
      ...
      <p className="mb-4">
        ...
        of the Platform constitutes acceptance of the updated Privacy Notice.
      </p>
